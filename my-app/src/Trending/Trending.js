                       ...
                       <ul class="list-inline favorites-slider row p-0 mb-0">
                          <li class="slide-item">
                                ...
                                <div class="block-images position-relative">
                                   ...
                                   <div class="block-description">
                                      <h6 class="iq-title"><a href="show-details.php">Inside the Sea</a></h6>
                                   ...
                                   <div class="block-social-info">
                                      <ul class="list-inline p-0 m-0 music-play-lists">
                                       <li class="share">
                                          ...
                                          <li data-toggle="modal" data-target="#exampleModalCenter" role="button">
                                              <span><i class="fas fa-info-circle" ></i></span>
                                            <span class="count-box">19+</span> 
                                           </li>
                                         <li><span><i class="fas fa-thumbs-up"></i></span>
                          ...
                          <li class="slide-item">
                                ...
                                <div class="block-images position-relative">
                                   ...
                                   <div class="block-description">
                                      <h6 class="iq-title"><a href="show-details.php">Jumbo Queen</a></h6>
                                      <div class="movie-time d-flex align-items-center my-2">
                          ...
                          <li class="slide-item">
                                ...
                                <div class="block-images position-relative">
                                   ...
                                   <div class="block-description">
                                      <h6 class="iq-title"><a href="show-details.php">Unknown Land</a></h6>
                                      <div class="movie-time d-flex align-items-center my-2">
                          ...
                          <li class="slide-item">                              
                                <div class="block-images position-relative">
                                   ...
                                   <div class="block-description">
                                      <h6 class="iq-title"><a href="show-details.php">Friends</a></h6>
                                      <div class="movie-time d-flex align-items-center my-2">
                          ...
                          <li class="slide-item">
                                ...
                                <div class="block-images position-relative">
                                   ...
                                   <div class="block-description">
                                      <h6 class="iq-title"><a href="show-details.php">Blood Block</a></h6>
                                      <div class="movie-time d-flex align-items-center my-2">
