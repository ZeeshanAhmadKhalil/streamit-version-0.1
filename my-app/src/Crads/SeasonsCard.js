        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-sm-12 overflow-hidden">
              {/* <div className="">
                <h4 className="main-title">Latest Seasons</h4>
                <a className="iq-view-all" href="movie-category.html">
                  View All
                </a>
              </div> */}
              <div className="favorites-contetns ">
                ...
                <li className=" saparate-container col-md-4 col-lg-4  d-flex flex-column  justify-content-center align-items-center slide-item popular-seasons-container">
                  ...
                  <li className="col-md-2 col-lg-2 mb-4 pl-0 pr-0 slide-item">
                  ...
                  <li className="col-md-2 col-lg-2 mb-4 pl-0 pr-0 slide-item">
                    <div className="block-images position-relative">
                      ...
                      <div className="block-social-info">
                        <ul className="col-md-2 col-lg-2 mb-4 pl-0 pr-0 list-inline p-0 m-0 music-play-lists">
                          <li className="share">
                            <span>
                              <i className="ri-share-fill"></i>
                            </span>
