         ...
         <div class="row">
            <div class="col-sm-12">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <a class="navbar-brand" href="index.html"> <img class="img-fluid logo" src="http://multitude.io/frontend/images/logo.png"
                     alt="streamit" /> </a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <div class="menu-main-menu-container">
                        <ul id="top-menu" class="navbar-nav ml-auto">
                           ...
                           <li class="menu-item">
                              <a href="show-category.html">Trending</a>
                           </li>                                                              
                           <li class="menu-item">
                              <a href="#">Blog</a>
                              <ul class="sub-menu">
                           ...
                           <li class="menu-item">
                              <a href="#">Catagories</a>
                              <ul class="sub-menu">
                                 <li class="menu-item"><a href="about-us.html">Cartoon</a></li>
                                 <li class="menu-item "><a href="contact.html">Adventure</a></li>
                                 <li class="menu-item"><a href="faq.html">Comedy</a></li>
                                 <li class="menu-item"><a href="privacy-policy.html">Thriller</a></li>
                                 <li class="menu-item"><a href="#">Suspense</a>
                              </li>
                              </ul>
                           </li>
                        </ul>
